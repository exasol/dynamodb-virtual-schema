...
/**
 * This {@link AbstractDynamodbResultWalker} does walks on object property. For example applied on the path
 * {@code author.name} the walker returns an AttributeValue of type Map with {@code name} as key.
 */
public class ObjectDynamodbResultWalker extends AbstractDynamodbResultWalker {
    ...
    public static class Builder extends AbstractDynamodbResultWalkerBuilder {
         ...
         * 
         * @param previousBuilder previous builder in chain
         * @param lookupKey       DynamoDB property name
         */
    ...
    /**
     * Exception that is thrown if the defined DynamoDB property is not present in a document.
     */
