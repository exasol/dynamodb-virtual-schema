...
public class BinaryLogicalOperator<DocumentVisitorType> implements QueryPredicate<DocumentVisitorType> {
     ...
     */
    public BinaryLogicalOperator(final List<QueryPredicate<DocumentVisitorType>> operands, final Operator operator) {
