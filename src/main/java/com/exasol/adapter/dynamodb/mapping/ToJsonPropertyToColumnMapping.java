...
public final class ToJsonPropertyToColumnMapping extends AbstractPropertyToColumnMapping {
    private static final long serialVersionUID = 4242655137009886007L;
     ...
     * @param maxSize              Maximum string size of the Exasol column
    ...
    /**
     * Get the {@link OverflowBehaviour} that is used if the result size exceeds the {@link #maxSize}.
     *
    ...
    public ColumnMapping withNewExasolName(final String newExasolName) {
        return new ToJsonPropertyToColumnMapping(newExasolName, this.getPathToSourceProperty(),
                this.getLookupFailBehaviour(), this.maxSize, this.overflowBehaviour);
    }
    ...
    public boolean equals(final Object other) {
        ...
        return this.maxSize == that.maxSize && this.overflowBehaviour.equals(that.overflowBehaviour)
                && super.equals(other);
    }

    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), this.getClass().getName(), this.overflowBehaviour, this.maxSize);
    }
