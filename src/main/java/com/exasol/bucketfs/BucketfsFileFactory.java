...
/**
 * Factory for files in bucketfs. Breaking out of the bucketfs using injection
 * is prevented.
 */
public class BucketfsFileFactory {
	 ...
	 * 
	 * @param path:
	 *            bucketfs path. e.g. {@code /bfsdefault/default/folder/file.txt}
	 * @return File defined by the path
	 * @throws BucketfsPathException
	 *             if path is invalid or on injection
	 */
