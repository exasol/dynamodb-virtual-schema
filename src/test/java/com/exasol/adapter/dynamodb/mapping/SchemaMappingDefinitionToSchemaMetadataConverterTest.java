...
public class SchemaMappingDefinitionToSchemaMetadataConverterTest {
    ...
    void testConvert() throws IOException {
        ...
        final List<String> columnNames = firstTable.getColumns().stream().map(column -> column.getName()).collect(Collectors.toList());
    ...
    void testSerialization() throws IOException, ClassNotFoundException {
        ...
        final ColumnMappingDefinition columnMappingDefinition = SchemaMappingDefinitionToSchemaMetadataConverter.convertBackColumn(firstColumnMetadata);
