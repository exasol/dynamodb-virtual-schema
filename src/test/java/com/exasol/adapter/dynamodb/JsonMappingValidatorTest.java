...
public class JsonMappingValidatorTest {
    ...
    void testInvalidNoDestName() throws IOException {
        final JsonMappingProvider.MappingException exception = assertThrows(JsonMappingProvider.MappingException.class, () -> runValidation("invalidMappingNoDestTableName.json"));
    ...
    void testInvalidNoSchemaSet() throws IOException {
        final JsonMappingProvider.MappingException exception = assertThrows(JsonMappingProvider.MappingException.class, () -> runValidation("invalidMappingNoSchemaSet.json"));
        assertThat(exception.getMessage(), equalTo("#: required key [$schema] not found"));
    }

    @Test
    void testInvalidWrongSchemaSet() throws IOException {
        final JsonMappingProvider.MappingException exception = assertThrows(JsonMappingProvider.MappingException.class, () -> runValidation("invalidMappingWrongSchemaSet.json"));
    ...
    void testInvalidUnknownRootProperty() throws IOException {
        final JsonMappingProvider.MappingException exception = assertThrows(JsonMappingProvider.MappingException.class, () -> runValidation("invalidMappingUnknownRootProperty.json"));
    ...
    void testInvalidUnknownMappingType() throws IOException {
        final JsonMappingProvider.MappingException exception = assertThrows(JsonMappingProvider.MappingException.class, () -> runValidation("invalidMappingUnknownMappingType.json"));
        assertThat(exception.getMessage(), equalTo("#/mapping/children/isbn: extraneous key [toStriiiiiiingMapping] is not permitted, use one of the following mapping definitions here: toTableMapping, children, toJsonMapping, toStringMapping"));
    }

    @Test
    void testInvalidToTableWithNoChildren() throws IOException {
        final JsonMappingProvider.MappingException exception = assertThrows(JsonMappingProvider.MappingException.class, () -> runValidation("invalidToTableMappingWithNoChildren.json"));
        assertThat(exception.getMessage(), equalTo("#/mapping/children/topics/toTableMapping/mapping please specify at least one mapping here. Possible are: toTableMapping, children, toJsonMapping, toStringMapping"));
    }

    @Test
    void testInvalidNoChildren() throws IOException {
        final JsonMappingProvider.MappingException exception = assertThrows(JsonMappingProvider.MappingException.class, () -> runValidation("invalidMappingNoMapping.json"));
    ...
    void testInvalidUnknownMappingInToTable() throws IOException {
        final JsonMappingProvider.MappingException exception = assertThrows(JsonMappingProvider.MappingException.class, () -> runValidation("invalidMappingUnknownMappingTypeInToTable.json"));
        assertThat(exception.getMessage(), equalTo("#/mapping/children/topics/toTableMapping/mapping: extraneous key [toStriiiiingMapping] is not permitted, use one of the following mapping definitions here: toTableMapping, children, toJsonMapping, toStringMapping"));
    }
}
