...
/**
 * Tests the
 * {@link DynamodbAdapter#createVirtualSchema(ExaMetadata, CreateVirtualSchemaRequest)}
 * and
 * {@link DynamodbAdapter#dropVirtualSchema(ExaMetadata, DropVirtualSchemaRequest)}
 * using a local docker version of DynamoDB and a local docker version of
 * exasol.
 **/
@Tag("integration")
@Testcontainers
