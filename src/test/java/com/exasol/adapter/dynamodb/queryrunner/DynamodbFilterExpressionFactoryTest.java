...
class DynamodbFilterExpressionFactoryTest {
    ...
    void testComparison() {
        ...
        final ColumnLiteralComparisonPredicate<DynamodbNodeVisitor> predicate = getComparison(literal, ComparisonPredicate.Operator.EQUAL);
    ...
    void testAndWithTwoOperands() {
        ...
        final ColumnLiteralComparisonPredicate<DynamodbNodeVisitor> comparison1 = getComparison(literal1, ComparisonPredicate.Operator.EQUAL);
        final ColumnLiteralComparisonPredicate<DynamodbNodeVisitor> comparison2 = getComparison(literal2, ComparisonPredicate.Operator.EQUAL);
        final LogicalOperator<DynamodbNodeVisitor> and = new LogicalOperator<>(List.of(comparison1, comparison2), LogicalOperator.Operator.AND);
        final DynamodbValueListBuilder valueListBuilder = new DynamodbValueListBuilder();
    ...
    void testAndWithThreeOperands() {
        ...
        final ColumnLiteralComparisonPredicate<DynamodbNodeVisitor> comparison1 = getComparison(literal1, ComparisonPredicate.Operator.EQUAL);
        final ColumnLiteralComparisonPredicate<DynamodbNodeVisitor> comparison2 = getComparison(literal2, ComparisonPredicate.Operator.EQUAL);
        final ColumnLiteralComparisonPredicate<DynamodbNodeVisitor> comparison3 = getComparison(literal3, ComparisonPredicate.Operator.EQUAL);
        final LogicalOperator<DynamodbNodeVisitor> and = new LogicalOperator<>(List.of(comparison1, comparison2, comparison3), LogicalOperator.Operator.AND);
        final DynamodbValueListBuilder valueListBuilder = new DynamodbValueListBuilder();
        final String result = new DynamodbFilterExpressionFactory().buildFilterExpression(and, valueListBuilder);
    ...
    void testNoPredicate(){
        final String result = new DynamodbFilterExpressionFactory().buildFilterExpression(new NoPredicate<>(), new DynamodbValueListBuilder());
        assertThat(result, equalTo(""));
    }

    @NotNull
    private ColumnLiteralComparisonPredicate<DynamodbNodeVisitor> getComparison(final String literal, final ComparisonPredicate.Operator operator) {
        ...
        return new ColumnLiteralComparisonPredicate<>(
                operator, column, new DynamodbString(literal));
    }
}
