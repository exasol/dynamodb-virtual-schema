    ...
    static void beforeAll()
        ...
        exasolTestInterface.createConnection(CONNECTION_NAME,
                "jdbc:amazondynamodb:Access Key=" + cdataCredentialProvider.getAwsAccessKey() + ";Secret Key="
                        ...
                        + cdataCredentialProvider.getRtk(),
                "not used", "anyway");
        createAdapterScript();
