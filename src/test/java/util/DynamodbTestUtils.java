...
public class DynamodbTestUtils {
    ...
    private static String getDockerNetworkURlForLocalDynamodb(final GenericContainer localDynamo, final Network thisNetwork) throws Exception {
    ...
    private DynamodbTestUtils(final String localUrl, final String dockerUrl, final String user, final String pass) {
        ...
        final StaticCredentialsProvider credentialsProvider = StaticCredentialsProvider.create(AwsBasicCredentials.create(user, pass));
